...
- <strong>数据集详情：</strong>
    ...
    |  名称 | 规模 | 创建日期 | 作者 | 单位 | 论文 | 下载 | 评测 |
    | :---: | :---:| :---: | :---: | :---: | :---: | :---: | :---: |
    | 情感对话数据 | 100万句对 | 2017年 | Zhou et al. | 清华 | [链接](https://arxiv.org/abs/1704.01074) | [链接](https://www.biendata.xyz/ccf_tcci2018/datasets/) | NLPCC 2017 [链接](https://www.biendata.xyz/ccf_tcci2018/#competition) |
...
- <strong>数据集详情：</strong>
    ...
    |  名称 | 规模 | 创建日期 | 作者 | 单位 | 论文 | 下载 | 评测 |
    | :---: | :---:| :---: | :---: | :---: | :---: | :---: | :---: |
    | 个性对话数据集 | 4.5k多轮对话session | 2020年 | Zhou et al. | 清华 | [链接](https://arxiv.org/abs/2004.04100) | [链接](https://github.com/skywindy/KdConv/) | 无 |
